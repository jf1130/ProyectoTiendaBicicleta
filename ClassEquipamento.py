from EnumTipoTela import EnumTipoTela
from EnumTipoEquipamento import EnumTipoEquipamento
from EnumTalla import EnumTalla
from ClassEquipamento import Producto
